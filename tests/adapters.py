...
def run_linear(
    ...
    from transformer.linear_module import Linear
...
def run_embedding(
    ...
    from transformer.embedding_module import Embedding
...
def run_rmsnorm(
    ...
    """
    from transformer.rmsnorm_module import RMSNorm
...
def get_tokenizer(
    ...
    from tokenizer_experiments.tokenizer import Tokenizer
